...
test "atx headings - example 32" {
    ...
    checkToken(t.tokens.items[0], Token{ .ID = TokenId.AtxHeader, .start = 0, .end = 1, .string = "#" });
    ...
    checkToken(t.tokens.items[4], Token{ .ID = TokenId.AtxHeader, .start = 6, .end = 8, .string = "##" });
    ...
    checkToken(t.tokens.items[8], Token{ .ID = TokenId.AtxHeader, .start = 13, .end = 16, .string = "###" });
    ...
    checkToken(t.tokens.items[12], Token{ .ID = TokenId.AtxHeader, .start = 21, .end = 25, .string = "####" });
    ...
    checkToken(t.tokens.items[16], Token{ .ID = TokenId.AtxHeader, .start = 30, .end = 35, .string = "#####" });
    ...
    checkToken(t.tokens.items[20], Token{ .ID = TokenId.AtxHeader, .start = 40, .end = 46, .string = "######" });
